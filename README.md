...
Скрипт использует только стандартную библиотеку Python. Запустить код на исходном [файле](https://ctlab.itmo.ru/~aivanov/ct_algo_2026/reads.fastq) (предварительно: ОБЯЗАТЕЛЬНО нужно скачать файл или прикрепить в директорию, где запускаете код свой готовый исходник), можно с помощью команды:
```bash
